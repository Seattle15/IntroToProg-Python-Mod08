...
class Product():
    ...
    def __str__(self):
        ...
        return product_info  # a string with product name and price; saved to the list
    ...
    def remove_data_from_list(product, lstOfProductObjects):
        ...
        for row in lstOfProductObjects:
            ...
            if product == product_local.strip():  # remove the user selected product
                ...
                status = 'Product was not in list.'
        return lstOfProductObjects, status
...
class IO:
    ...
    def input_new_price(product_object):
        ...
        product_object.product_price = productPrice
...
lstOfProductObjects, status = FileProcessor.read_data_from_file(strFileName)  # read file data into list table
print(status)   # feedback to user regarding file contents
IO.print_current_Products_in_list(lstOfProductObjects)  # shows current data in the list
